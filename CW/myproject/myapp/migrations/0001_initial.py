# Generated by Django 6.0.2 on 2026-02-14 05:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roles', models.CharField(choices=[('Job_Seeker', 'Job_Seeker'), ('Recruiter', 'Recruiter')], max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cover_letter', models.FileField(null=True, upload_to='file/')),
